  ...
  return (
    <div className="bg-white text-black dark:bg-black dark:text-white font-serif min-h-screen">
      <div className="px-4 py-16 text-center">
        <h1 className="text-2xl font-sans font-bold text-black dark:text-white mb-8">
          UKIAH UNITED METHODIST CHURCH
        </h1>
        <p className="text-lg font-serif italic text-black dark:text-white mb-8">
        ...
        <div className="max-w-md mx-auto">
          ...
          <p className="font-serif text-black dark:text-white leading-relaxed mb-8">
